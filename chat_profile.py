...
# Debug: Print the endpoint to verify it's being read correctly
...
if __name__ == "__main__":
    print("Hello Langchain, Using LLM")

    summary_template = """
        given the information {info} about person I want you to create:
        1. a short summary
    ...
    llm = OllamaLLM(model="llama3", endpoint=ollama_endpoint)
